...
public sealed class GetChronologicalFeedQueryHandler : IQueryHandler<GetChronologicalFeedQuery, CursorPagedFeedDto>
{
    ...
    public GetChronologicalFeedQueryHandler(
    ...
    public async Task<Result<CursorPagedFeedDto>> Handle(GetChronologicalFeedQuery request, CancellationToken cancellationToken)
    {
        ...
        var (entries, hasMore) = await _feedRepository.GetChronologicalFeedAsync(request.RequesterId, cursor, pageSize, cancellationToken);
