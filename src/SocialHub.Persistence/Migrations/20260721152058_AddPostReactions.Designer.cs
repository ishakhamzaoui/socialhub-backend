...
namespace SocialHub.Persistence.Migrations
{
    ...
    [Migration("20260721152058_AddPostReactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialHub.Domain.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SocialHub.Domain.Comments.CommentMention", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SocialHub.Domain.Comments.CommentReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SocialHub.Domain.Comments.CommentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SocialHub.Domain.Comments.Comment", b =>
                {
                    b.HasOne("SocialHub.Domain.Comments.Comment", null)
                        .WithMany()
